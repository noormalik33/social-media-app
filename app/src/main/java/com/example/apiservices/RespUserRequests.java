...
public class RespUserRequests implements Serializable {
    ...
    public ItemUserRequests getUserRequestsList() {
        return itemUser instanceof ItemUserRequests ? (ItemUserRequests) itemUser : null;
    }
